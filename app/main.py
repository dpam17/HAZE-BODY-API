...
@app.get("/health")
def health():
    return {"status": "BodyMetrics API is running"}


# --- Root Endpoint ---
# Returns the branded HTML page anyone can use to test the API
...
def root():
    ...
    <head>
        ...
        <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' fill='black'/><text y='.9em' font-size='70' x='50%' dominant-baseline='middle' text-anchor='middle' fill='white' font-family='serif'>B</text></svg>">
        <style>
    ...
    <body>
        <div class="haze-card">
            ...
            <div class="height-row">
                ...
                <div class="height-control">
                    <button class="height-btn" onclick="adjustHeight(-1)">−</button>
                    <span class="height-display" id="heightDisplay">170</span>
                    <button class="height-btn" onclick="adjustHeight(1)">+</button>
                </div>
                <input type="hidden" id="heightInput" value="170">
            ...
            <div class="haze-footer">
                <div class="footer-text">BodyMetrics · 2026</div>
            </div>
        ...
        <script>
            ...
            function adjustHeight(delta) {
                ...
                current = Math.min(250, Math.max(100, current + delta));
                input.value = current;
